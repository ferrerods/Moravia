#pragma checksum "C:\Users\Chano\source\repos\Moravia\ChessProject\Views\Chess\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4ecf0f014fb93cdb5152be3fb8172d462eb5c2f7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4ecf0f014fb93cdb5152be3fb8172d462eb5c2f7", @"/Views/Chess/Index.cshtml")]
...
#nullable disable
     ...
     ");
            ...
            function findOutPiece(pieceSelected, positionInitial, positionSelected) {
                ...
                WriteLiteral(@"  break;
                    ...
                    case ""♛"": //queen black
                 ");
                WriteLiteral(@"       return getMoveQueen(positionInitial, positionSelected);
                        break;
                    case ""♕"": //queen white
    ...
    ");
                WriteLiteral(@"                // si es misma columna puede moverse siempre y cuando sea de una casilla
            ...
            function getMoveTower(positionInitial, positionSelected) {
                ...
                WriteLiteral(@"rriba
                    ...
                    if (arrayPositionInitial[1] == arrayPositionSelected[1]) {
                        ...
                        if (arrayPositionInit");
                WriteLiteral(@"ial[2] > arrayPositionSelected[2]) {
...
");
                WriteLiteral(@"                {
                    ...
                    if (idx > idxS) { 
                        // arriba 
                   ");
                WriteLiteral(@"     if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
            ...
            function getMoveHorse(positionInitial, positionSelected) {
                ...
                var arrayPositionSelected = positionSelected.split("""");
                var ");
                WriteLiteral(@"idx = FindPosition(row, arrayPositionInitial[2]);
                var idxS = FindPosition(row, arrayPositionSelected[2]);
            ...
            function getMoveQueen(positionInitial, positionSelected) {
                ...
                //se mueve en la misma columna
                if (arrayPo");
                WriteLiteral(@"sitionInitial[2] == arrayPositionSelected[2]) {
                    //se mueve hacia abajo
                    if (arrayPositionInitial[1] > arrayPositionSelected[1]) {
                        var existPiecesDownUp = ExistPiecesTheWay(true, true, arrayPositionInitial, arrayPositionSelected);
                        if (existPiecesDownUp) { return false; }
                ...
                if (arrayPositionInitial[1] == arrayPositionSelected[1]) {
                    // se mueve a derecha ->
             ");
                WriteLiteral(@"       if (arrayPositionInitial[2] < arrayPositionSelected[2]) {
                        var existPiecesR = ExistPiecesTheWay(false, true, arrayPositionInitial, arrayPositionSelected);
                        if (existPiecesR) { return false; }
                        else { return true; }
                ...
                if (idx < idxS) {
                    // arriba 
                    if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
                        var resultMov = ExistPiecesTheWayDiagonal(true, true, arrayPositionInitial, arrayPositionSelect");
                WriteLiteral(@"ed);
                        if (resultMov) { return false; }
                        else { return true; }
                    }
                ...
                if (idx > idxS) {
                    ...
                    // abajo 
                    if (arrayP");
                WriteLiteral(@"ositionInitial[1] > arrayPositionSelected[1]) {
                        var resultMov = ExistPiecesTheWayDiagonal(false, false, arrayPositionInitial, arrayPositionSelected);
                        if (resultMov) { return false; }
                        else { return true; }
                    }
...
");
 ...
 ");
            ...
            //lineal 
            function ExistPiecesTheWay(boolWay, boolWayTow, arr");
                WriteLiteral(@"ayPositionInitial, arrayPositionSelected)
            {
                var i = arrayPositionInitial[1];
                var colorPieceSeleted = PieceColor(pieceSelected);
                ...
                if (boolWay && boolWayTow == false) {
                    i++;
                    for (i; i <= arrayPositionSelected[1]; i++) {
                        var id = ""#"" + i + arrayPositionSe");
                WriteLiteral(@"lected[2];
                        if ($(id)[0].innerText != """") {
                            return true;
                            break;
                        }
                ...
                //boolWay: si es fila = false
                //bo");
                WriteLiteral(@"olWayTow: para izquierda false <-
            ...
            function ExistPiecesTheWayDiagonal(boolWay, boolWayTow, arrayPositionInitial, arrayPositionSelected)
            {
                ...
                //bool");
                WriteLiteral(@"Way: si es izquierda false
                //boolWayTow: para abajo false
                if (boolWay == false && boolWayTow) {
                    i--;
                    idx--;

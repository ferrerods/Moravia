#pragma checksum "C:\Users\Chano\source\repos\Moravia\ChessProject\Views\Chess\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c86b1a537ca3fb0357bfd450d3347480c9546bc4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c86b1a537ca3fb0357bfd450d3347480c9546bc4", @"/Views/Chess/Index.cshtml")]
...
#nullable disable
                WriteLiteral("\';\r\n            });\r\n\r\n            if (\'");
#nullable restore
#line 148 "C:\Users\Chano\source\repos\Moravia\ChessProject\Views\Chess\Index.cshtml"
...
#nullable disable
        ...
        ");
          ...
          ");
            ...
            function ValidateMove(pieceSelected, positionInitial, positionSelected) {
                ...
                alert(""canPieceMove "" + canPieceMove);
                ...
                if (!canPieceMove) {
                    ...
                    if ($(positionSelected)[0].innerText != """") {
                        var colorPieceToMove = PieceColor(pieceSelected);
                        var colorPieceInNewPosition = PieceColor($(positionSelected)[0].innerText);

                        alert(""colorPieceToMove "" + colorPieceToMove);
                        alert(""colorPieceInNewPosition "" + colorPieceInNewPosition);
                        ...
                        if (colorPieceInNewPosition == colorPieceToMove) {
                         ...
                         ");
                WriteLiteral(@"   //coloco la pieza en la nueva posicion 
            ...
            function getMovePawn(boolColor, positionInitial, positionSelected) {
                ...
                if (boolColor) {
                    ...
                    if (arrayPositionInitial[2] == arrayPositionSelected[2]) {
                        ...
                        //puede comer
                        if (arrayPo");
                WriteLiteral(@"sitionSelected[1] == rowBefore || arrayPositionInitial[1] == rowAfter) {
                            return true;
                        } else { return false; }
                    }
                }
                    ...
                    if (arrayPositionInitial[2] == arrayPositionSelected[2]) {
                        ...
                        //puede comer
                      ");
                WriteLiteral(@"  if (arrayPositionInitial[1] == rowBefore || arrayPositionInitial[1] == rowAfter) {
                            return true;
                        } else { return false; }
                    }
                }
                    ...
                    || (arrayPositionInitial[1] == arrayPositionSelected[1]))
                {
                    ...
                    if (arrayPositionInitial[2] == arrayPositionSelected[2]) {
                        ...
                        if (arrayPositionInitial[1] > arrayPositionSelected[1]) {
                            var existPiecesDownUp = ExistPiecesTheWay(true, true, arrayPositionInitial, arrayPositi");
                WriteLiteral(@"onSelected);
        ...
        ");
                WriteLiteral(@"                    if (existPiecesR) { return false; }
                            else { return true; }
  ...
  ");
                WriteLiteral(@"          function getMoveHorse(positionInitial, positionSelected) {
            ...
            function getMoveQueen(positionInitial, positionSelected) {

                var arrayPositionInitial = positionInitial.split("""");
                var arrayPositionSelected = positionSelect");
                WriteLiteral(@"ed.split("""");
                var idx = FindPosition(row, arrayPositionInitial[2]);
                var idxS = FindPosition(row, arrayPositionSelected[2]);
                ...
                if (idx > idxS) {
                    // arriba 
                    if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
                        var resultMov = ExistPiecesTheWayDiagonal(false, true, ar");
                WriteLiteral(@"rayPositionInitial, arrayPositionSelected);
                        if (resultMov) { return false; }
                        else { return true; }
                    }
            ...
            function getMoveKing(positionInitial, positionSelected) {
                ...
                if ((valueAbsC == 0 && valueAbsR == 1)
                    ...
                    if (arrayPositionInitial[2] == arrayPositionSelected[2]) {
                        ...
                        //se mueve hacia arriba
                        if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
                            var existPiecesUpDown = ExistPiecesTheWay(true, false, arrayPositionInitial, array");
                WriteLiteral(@"PositionSelected);
                            if (existPiecesUpDown) { return false; }
                            else { return true; }
                        }
                    }
...
");
      ...
      ");
            ...
            //lineal 
            function ExistPie");
                WriteLiteral(@"cesTheWay(boolWay, boolWayTow, arrayPositionInitial, arrayPositionSelected)
            {
                ...
                if (boolWay && boolWayTow) {
                    ...
                    for (i; i >= arrayPositionSelected[1]; i--) {
                        ...
                        if ($(id)[0].innerText != """" && i != arrayPositionSelected[1]) {
                            return true;
                            break;
                        }
       ...
       ");
                WriteLiteral(@"         if (boolWay && boolWayTow == false) {
                    i++;
                    for (i; i <= arrayPositionSelected[1]; i++) {
                        var id = ""#"" + i + arrayPositionSelected[2];
                        if ($(id)[0].innerText != """" && i != arrayPositionSelected[1]) {
                ...
                if (boolWay == false && boolWayTow) {
                    ...
                    idx++;
     ");
                WriteLiteral(@"               for (t = idx; t <= idxS; t++) {
                        var id = ""#"" + i + arrayPositionSelected[2];
                        if ($(id)[0].innerText != """") {
                            return true;
                            break;
            ...
            function ExistPiecesTheWayDiagonal(boolWay, boolWayTow, arrayPositionInitial, arrayPositionSelected)
            {
                ...
                if (boolWay == false && boolWayTow) {
                    ...
                    for (i; i >= arrayPositionSelected[1]; i--) {
            ");
                WriteLiteral(@"            for (idx; idx >= idxS[1]; idx--) {
                            var id = ""#"" + i + row[idx];
                            if ($(id)[0].innerText != """") {
                                return true;
                                break;

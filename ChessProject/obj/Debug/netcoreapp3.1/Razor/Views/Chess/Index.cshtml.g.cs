#pragma checksum "C:\Users\Chano\source\repos\Moravia\ChessProject\Views\Chess\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ad148ba7188c3aa55294f1572a5436afb7ba00b0"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ad148ba7188c3aa55294f1572a5436afb7ba00b0", @"/Views/Chess/Index.cshtml")]
...
#nullable disable
                ...
                if (!canPieceMove) {
                    ...
                    if ($(positionSelected)[0].innerText != """") {
                        ...
                        if (colorPieceInNewPosition == colorPieceToMove) {
                            ...
                            $(positionSelected).append(piec");
                WriteLiteral(@"eSelected);
                        }
                    }
                    else {
            ...
            function getMoveTower(positionInitial, positionSelected) {
                    ...
                    || (arrayPositionInitial[1] == arrayPositionSelected[1]))
                {
                    ...
                    if (arrayPositionInitial[2] == arrayPositionSelected[2]) {
                        ...
                        ");
                WriteLiteral(@"//se mueve hacia arriba
                        if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
                    ...
                    if (arrayPositionInitial[1] == arrayPositionSelected[1]) {
                        ...
                        if ");
                WriteLiteral(@"(arrayPositionInitial[2] > arrayPositionSelected[2]) {
 ...
 ");
            ...
            function getMoveHorse(positionInitial, positionSelected) {
                ...
                var arrayPositionSelected = positionSelected.split("""");
  ");
                WriteLiteral(@"              var idx = FindPosition(row, arrayPositionInitial[2]);
                var idxS = FindPosition(row, arrayPositionSelected[2]);
         ...
         ");
                ...
                if (idx < idxS) {
                    // arriba 
                    if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
                        var resultMov = ExistPiecesTheWayDiagonal(true, true, arrayPositionInitial, a");
                WriteLiteral(@"rrayPositionSelected);
                        if (resultMov) { return false; }
                        else { return true; }
                    }
            ...
            function getMoveKing(positionInitial, positionSelected) {
                ...
                WriteLiteral(@"lueAbsR == 1)) {
                    ...
                    //se ");
                WriteLiteral(@"mueve en la misma fila
                    if (arrayPositionInitial[1] == arrayPositionSelected[1]) {
                        // se mueve a derecha ->
                        if (idx < idxS) {
                            var existPiecesR = ExistPiecesTheWay(false, true, arrayPositionInitial, arrayPositionSelected);
           ...
           ");
                WriteLiteral(@"             if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
                    ...
                    if (idx > idxS) {
                        // arriba 
                        if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
                            var resultMov = ExistPiecesTheWayDiago");
                WriteLiteral(@"nal(false, true, arrayPositionInitial, arrayPositionSelected);
                            if (resultMov) { return false; }
                            else { return true; }
                        }
            ...
            function ExistPiecesTheWay(boolWay, boolWayTow, arrayPositionInitial, arrayPositionSelected)
            {
                ...
                //boolWayTo");
                WriteLiteral(@"w: para abajo true
                ...
                if (boolWay && boolWayTow == false) {
                    ...
                    for (i; i <= arrayPositionSelected[1]; i++) {
                        var id = ""#"" + i + arrayPositionSelected[2];
       ");
                WriteLiteral(@"                 if ($(id)[0].innerText != """" && i != arrayPositionSelected[1]) {
                            return true;
                            break;
                        }

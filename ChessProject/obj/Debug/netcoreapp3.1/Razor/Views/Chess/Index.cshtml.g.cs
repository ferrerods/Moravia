#pragma checksum "C:\Users\Dalila\source\repos\Moravia\ChessProject\Views\Chess\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d8bacd1e235ba036cfb686cb72e16bab3219576b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d8bacd1e235ba036cfb686cb72e16bab3219576b", @"/Views/Chess/Index.cshtml")]
...
#nullable disable
  ...
  ");
            ...
            function getMoveQueen(positionInitial, positionSelected) {
                ...
                var arrayPositionSelected = positionSelected.split("""");
                var idx = FindPosition(row, arrayPositionInitial[2]);
                var idxS = FindPositio");
                WriteLiteral(@"n(row, arrayPositionSelected[2]);
                ...
                if (idx < idxS) {
                    ...
                    if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
       ");
                WriteLiteral(@"                 var resultMov = ExistPiecesTheWayDiagonal(true, true, arrayPositionInitial, arrayPositionSelected);
                        if (resultMov) { return false; }
                        else { return true; }
                    }
         ...
         ");
                WriteLiteral(@"           || (valueAbsC == 1 && valueAbsR == 0)
                ...
                WriteLiteral(@"erecha
                    ...
                    if (idx > idxS) {
                        // arriba 
                        if (arrayPositionInitial[1] < a");
                WriteLiteral(@"rrayPositionSelected[1]) {
                            var resultMov = ExistPiecesTheWayDiagonal(false, true, arrayPositionInitial, arrayPositionSelected);
                            if (resultMov) { return false; }
                            else { return true; }
                        }
            ...
            function ExistPiecesTheWay(boolWay, boolWayTow, arrayPositionInitial, arrayPositionSelected)
            {
                ...
                if (boolWay && boolWayTow == false) {
                    i++;
                    for (i; i <= arrayPositionSele");
                WriteLiteral(@"cted[1]; i++) {
                        var id = ""#"" + i + arrayPositionSelected[2];
                        if ($(id)[0].innerText != """" && i != arrayPositionSelected[1]) {
                            return true;
                            break;
                ...
                if (boolWay == false && boolWayTow) {
                    ...
                    for (t = idx; t <= idxS; t++) {
                        var id = ""#"" + i + row[t];
                      ");
                WriteLiteral(@"  if ($(id)[0].innerText != """" && t != idxS) {
                            return true;
                            break;
                        }
        ...
        ");
                ...
                //boolW");
                WriteLiteral(@"ayTow: para arriba true
                if (boolWay == false && boolWayTow) {
                    i++;
                    idx--;

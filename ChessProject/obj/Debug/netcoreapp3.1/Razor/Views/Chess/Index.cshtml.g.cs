#pragma checksum "C:\Users\Chano\source\repos\Moravia\ChessProject\Views\Chess\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "92f820177590c15987a04531504a1feb509714e5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"92f820177590c15987a04531504a1feb509714e5", @"/Views/Chess/Index.cshtml")]
...
#nullable disable
  ...
  ");
            ...
            function getMovePawn(boolColor, positionInitial, positionSelected) {
                ...
                WriteLiteral(@"boolColor) {
                    ...
                    if (arrayPositionInitial[2] == arrayPositionSelected[2]) {
                        if (restWhite.toString() === ""1"" && $(positionSelected)[0].innerText == """") {
                            return true ;
                        } else {
                            return false; } 
                    }
                        ...
                        //puede comer
                        if (arrayPositionSelected[2] == rowBefore || arrayPositionSelected[2] == rowAfter) {
                            return true;
                        } else { return false; }
               ");
                WriteLiteral(@"     }
                    ...
                    if (arrayPositionInitial[2] == arrayPositionSelected[2]) {
                        if (restBlack.toString() === ""1"" && $(positionSelected)[0].innerText == """") {
                            return true;
                        } else {
                            return false;
                        }
            ...
            function getMoveBishop(positionInitial, positionSelected) {
                ...
                if ((arrayPositionInitial[2] == arrayPositionSelected[2])
                    |");
                WriteLiteral(@"| (arrayPositionInitial[1] == arrayPositionSelected[1])) {
                    return false;
                }
                else
                {
            ...
            function getMoveHorse(positionInitial, positionSelected) {
                ...
                var arrayPos");
                WriteLiteral(@"itionInitial = positionInitial.split("""");
                var arrayPositionSelected = positionSelected.split("""");
                var idx = FindPosition(row, arrayPositionInitial[2]);
                var idxS = FindPosition(row, arrayPositionSelected[2]);
            ...
            function getMoveQueen(positionInitial, positionSelected) {
                ...
                var idx = FindPosition(row, arrayPositionInitial[2]);
              ");
                WriteLiteral(@"  var idxS = FindPosition(row, arrayPositionSelected[2]);
                ...
                if (idx < idxS) {
                    // arriba 
                    if (arrayPositionInitial[1] < arrayPositio");
                WriteLiteral(@"nSelected[1]) {
                        var resultMov = ExistPiecesTheWayDiagonal(true, true, arrayPositionInitial, arrayPositionSelected);
                        if (resultMov) { return false; }
                        else { return true; }
                    }
        ...
        ");
                WriteLiteral(@"            //Diagonal derecha
                    ...
                    if (idx > idxS) {
                        // arriba 
                        if (arr");
                WriteLiteral(@"ayPositionInitial[1] < arrayPositionSelected[1]) {
                            var resultMov = ExistPiecesTheWayDiagonal(false, true, arrayPositionInitial, arrayPositionSelected);
                            if (resultMov) { return false; }
                            else { return true; }
                        }
            ...
            {
        ");
                WriteLiteral(@"        var i = arrayPositionInitial[1];
                ...
                if (boolWay && boolWayTow == false) {
                    i++;
                    for (i");
                WriteLiteral(@"; i <= arrayPositionSelected[1]; i++) {
                        var id = ""#"" + i + arrayPositionSelected[2];
                        if ($(id)[0].innerText != """" && i != arrayPositionSelected[1]) {
                            return true;
                            break;

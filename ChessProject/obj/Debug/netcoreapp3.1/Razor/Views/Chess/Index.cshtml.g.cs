#pragma checksum "C:\Users\Dalila\source\repos\Moravia\ChessProject\Views\Chess\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d2355ba4b6cec9dec6486fc36dc95633b6f97845"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d2355ba4b6cec9dec6486fc36dc95633b6f97845", @"/Views/Chess/Index.cshtml")]
...
#nullable disable
     ...
     ");
                WriteLiteral(@"                   // se procede a realizar el movimiento
                        $(positionInitial).empty();
                        $(positionSelected).append(pieceSelected);
                    }
                }
            ...
            function getMovePawn(boolColor, positionInitial, positionSelected) {
                ...
                if (boolColor) {
                    ...
                    var restWhi");
                WriteLiteral(@"te = parseInt(arrayPositionSelected[1]) - parseInt(arrayPositionInitial[1]);
                    ...
                    var restBlack = parseI");
                WriteLiteral(@"nt(arrayPositionInitial[1]) - parseInt(arrayPositionSelected[1]);
                    if (arrayPositionInitial[2] == arrayPositionSelected[2]) {
            ...
            function getMoveTower(positionInitial, positionSelected) {
                ...
                var arrayPositionInitial = positionInitia");
                WriteLiteral(@"l.split("""");
                    ...
                    || (arrayPositionInitial[1] == arrayPositionSelected[1]))
                {
                    ...
                    if (arrayPositionInitial[2] == arrayPositionSelected[2]) {
                        ...
                        if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
                            var existPiece");
                WriteLiteral(@"sUpDown = ExistPiecesTheWay(true, false, arrayPositionInitial, arrayPositionSelected);
                    ...
                    if (arrayPositionInitial[1] == arrayPositionSelected[1]) {
                        ...
                        if (arrayPositionInitial[2] > arrayPositionSelected[2]) {
                            var existPiecesL = ExistPiecesTheWay(false, false, arrayPositionIn");
                WriteLiteral(@"itial, arrayPositionSelected);
     ...
     ");
                WriteLiteral(@"                   if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
                    ...
                    if (idx > idxS) { 
                        // arriba 
                        if (arrayPositionInitial[1] < arrayPositionSelected[1]) {
                            var resultMov = ExistPiecesTheWayDiagona");
                WriteLiteral(@"l(false, true, arrayPositionInitial, arrayPositionSelected);
                            if (resultMov) { return false; }
                            else { return true; }
                        }
      ...
      ");
                WriteLiteral(@"          var valueAbsC = Math.abs(arrayPositionInitial[1] - arrayPositionSelected[1]);
            ...
            function getMoveQueen(boolColor, positionInitial, positionSelected) {
                ...
                if (arrayPositionInitial[2] == arrayPositionSelected[2]) {
                    //se mueve hacia abajo
                    if (arrayPositio");
                WriteLiteral(@"nInitial[1] > arrayPositionSelected[1]) {
                        var existPiecesDownUp = ExistPiecesTheWay(true, true, arrayPositionInitial, arrayPositionSelected);
                        if (existPiecesDownUp) { return false; }
                        else { return true; }
                ...
                if (arrayPositionInitial[1] == arrayPositionSelected[1]) {
                    // se mueve a derecha ->
                    if (arrayPositionInitial[2] < arrayPositionSelected[2]) {
                        var existPiecesR = ExistPiecesTheWay(fa");
                WriteLiteral(@"lse, true, arrayPositionInitial, arrayPositionSelected);
                        if (existPiecesR) { return false; }
                        else { return true; }
                ...
                if (idx < idxS) {
                    ...
                    // abajo 
                    if (arrayPositionInitial[1] > arrayPositionSelected[1]) {
                        var resultMov = ExistPiecesTheWayDiagonal(false, false, ");
                WriteLiteral(@"arrayPositionInitial, arrayPositionSelected);
                        if (resultMov) { return false; }
                        else { return true; }
                    }
                }
      ...
      ");
                WriteLiteral(@"                  if (arrayPositionInitial[1] > arrayPositionSelected[1]) {
                    ...
                    if (arrayPositionInitial[1] == arrayPositionSelected[1]) {
                        ...
                        if (idx < idxS) {
         ");
                WriteLiteral(@"                   var existPiecesR = ExistPiecesTheWay(false, true, arrayPositionInitial, arrayPositionSelected);
                            if (existPiecesR) { return false; }
                            else { return true; }
            ...
            function ExistPiecesTheWay(boolWay, boolWayTow, arrayPositionInitial, arrayPositionSelected)
            {
                ...
                if (boolWay && boolWayTow) {
                    ...
                    for (i; i >= arrayPositionSelected[1]; i--) {
                        var id = ""#"" + i + arra");
                WriteLiteral(@"yPositionSelected[2];
                        if ($(id)[0].innerText != """") {
                            return true;
                            break;
                        }
                ...
                if (boolWay == false && boolWayTow) {
                    ...
                    var idx = FindPosition(row, a");
                WriteLiteral(@"rrayPositionInitial[2]);
                    var idxS = FindPosition(row, arrayPositionSelected[2]);
